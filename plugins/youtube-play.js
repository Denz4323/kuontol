...
⬡ Upload: ${publishedTime}
⬡ Link: ${vid.url}
╰────────⬣`, author.trim(), await( await conn.getFile(thumbnail)).data, ['📽VIDEO', `${usedPrefix}getvid ${url} 360`], false, { quoted: m, 'document': { 'url':'https://youtube.com/@DenzCreator' },
...
body: wm,
sourceUrl: 'https://youtube.com/@DenzCreator', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})

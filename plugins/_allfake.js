		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					body: wm,
					mediaUrl: sgc,
					description: 'Denn BOT-MultiDevice',
					previewType: "PHOTO",
...
global.fakefb = {
        ...
        global.fvn = {
            ...
            message: { "liveLocationMessage": { "caption":"by : Denn BOT","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
